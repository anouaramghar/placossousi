      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col justify-center animate-fade-in-up md:order-2 order-1" style={{ animationDelay: '0.1s' }}>
            ...
            <p className="text-brand-100 text-lg md:text-xl leading-[1.8] font-light mb-12 mix-blend-plus-lighter">{description}</p>
            <a
              href="https://wa.me/212665652991"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-3 bg-[#25d366] hover:bg-[#20bd5a] shadow-[0_4px_20px_rgba(37,211,102,0.3)] hover:shadow-[0_8px_30px_rgba(37,211,102,0.5)] text-white font-bold px-10 py-4 rounded-full transition-all duration-300 hover:-translate-y-1 w-fit group"
            >
