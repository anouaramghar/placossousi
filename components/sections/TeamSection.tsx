  ...
  return (
    ...
    >
      <div className={`relative mb-5 transition-colors duration-500 ${isTop
        ? 'w-[145px] h-[195px] sm:w-[240px] sm:h-[320px] md:w-[280px] md:h-[380px]' // Larger portrait sizing for leader
    ...
    <section id="team" className="relative py-10 md:py-24 px-6 z-10 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center relative w-full">
          {/* Top Level - Leaders */}
          <div className="relative mb-10 md:mb-20 flex flex-row justify-center items-center gap-2 sm:gap-10 md:gap-14 w-full z-20">
