...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-36 px-6 z-10 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-purple-600/6 rounded-full blur-[120px] pointer-events-none -z-10"></div>

      <div className="max-w-6xl mx-auto">
        <div className="mb-20 reveal">
          <span className="section-label">{t('label')}</span>
          <h2 className="font-display text-transparent bg-clip-text bg-gradient-to-b from-white to-brand-200/50 text-[clamp(2.8rem,7vw,5.5rem)] tracking-[-0.04em] leading-[1.04] mt-5 text-glow-soft">{t('title')}</h2>
        </div>
        ...
        <div className="grid md:grid-cols-5 gap-12 lg:gap-16 items-start">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-[#0a1f11]/80 flex items-center justify-center flex-shrink-0 group-hover:bg-[#113a1f]/80 transition-colors relative">
                <div className="absolute inset-0 rounded-2xl bg-[#25d366] opacity-0 group-hover:opacity-20 blur-md transition-opacity"></div>
                <svg viewBox="0 0 24 24" className="w-7 h-7 fill-[#25d366] drop-shadow-[0_0_10px_rgba(37,211,102,0.5)] relative z-10 transition-transform group-hover:scale-110">
              ...
              <div>
                <p className="text-[#25d366]/80 text-xs md:text-sm mb-1 uppercase tracking-widest font-semibold">{t('whatsapp_label')}</p>
                <p className="text-white font-bold text-lg">0665 652 991</p>
              </div>
            </a>
          </div>
          ...
          <div className="md:col-span-3 mt-8 md:mt-0">
            <form onSubmit={handleSubmit} className="glass-card rounded-3xl p-8 md:p-10 border border-white/10 space-y-6 relative overflow-hidden shadow-2xl bg-white/[0.01]">
              ...
              <div className="grid sm:grid-cols-2 gap-6 relative z-10">
                <div>
                  <label htmlFor="contact-name" className="sr-only">{t('form_name')}</label>
                  <input
                    id="contact-name"
                    name="name"
                    type="text"
                    ...
                    className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-6 py-4 text-white placeholder-brand-300/50 focus:outline-none focus:border-brand-400/50 focus:bg-white/[0.06] focus:shadow-[0_0_15px_rgba(30,79,163,0.3)] transition-all font-medium backdrop-blur-md"
                  />
                </div>
                <div>
                  <label htmlFor="contact-phone" className="sr-only">{t('form_phone')}</label>
                  <input
                    id="contact-phone"
                    name="phone"
                    type="tel"
              ...
              <div className="relative z-10">
                <label htmlFor="contact-message" className="sr-only">{t('form_message')}</label>
                <textarea
                  id="contact-message"
                  name="message"
                  required
                  ...
                  className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-6 py-4 text-white placeholder-brand-300/50 focus:outline-none focus:border-brand-400/50 focus:bg-white/[0.06] focus:shadow-[0_0_15px_rgba(30,79,163,0.3)] transition-all font-medium resize-none backdrop-blur-md"
                />
              </div>
              <button
                type="submit"
