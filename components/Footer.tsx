    ...
    <footer className="relative bg-[#02060f] border-t border-white/5 pt-20 pb-10 px-6 overflow-hidden z-10">
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="mb-12 text-center group cursor-default">
          ...
          <p className="font-sans text-brand-300/40 text-xs tracking-[0.25em] uppercase font-semibold">{t('tagline')}</p>
        </div>

        {/* Bottom bar */}
        <div className="w-full flex flex-col md:flex-row items-center justify-between gap-5 pt-8 border-t border-white/4">
          <p className="font-sans text-brand-300/35 text-xs font-medium tracking-wider order-2 md:order-1">{t('copyright')}</p>
          ...
          <div className="flex items-center gap-2 order-1 md:order-2">
            <a
              ...
              className="text-brand-300/50 hover:text-white transition-all duration-200 hover:scale-110 flex items-center justify-center w-9 h-9 rounded-full hover:bg-white/5"
